...
def batsmanContributionWonLost(file,name="A Hitter"):
    ...
    plt.savefig('batsmanContributionWonLost.png')
    plt.show()
    plt.gcf().clear()
    return
...
def batsmanCumulativeStrikeRate(file,name="A Leg Glance"):  
    ...
    plt.savefig('batsmanCumulativeStrikeRate.png')
    plt.show()
    plt.gcf().clear()
    return
...
def batsmanDismissals(file, name="A Squarecut"):
    ...
    plt.savefig('batsmanDismissals.png')
    plt.show()
    plt.gcf().clear()
    return
...
def batsmanMeanStrikeRate(file, name="A Hitter"):
    ...
    plt.savefig('batsmanMeanStrikeRate.png')
    plt.show()
    plt.gcf().clear()
    return
...
def batsmanMovingAverage(file,name="A Squarecut") :
    ...
    plt.savefig('batsmanMovingAverage.png')
    plt.show()
    plt.gcf().clear()
    return
...
def batsmanPerfBoxHist(file, name="A Hitter"):
    ...
    plt.savefig('batsmanPerfBoxHist.png')
    plt.show()
    plt.gcf().clear()
    return    
...
def batsmanPerfForecast(file, name="A Squarecut"):
    ...
    residuals.plot()
    plt.savefig('batsmanPerfForecast_1.png')
    plt.show()
    residuals.plot(kind='kde')
    plt.savefig('batsmanPerfForecast_2.png')
    plt.show()
    plt.gcf().clear()
...
def batsmanPerfHomeAway(file,name="A Hitter"):
    ...
    plt.savefig('batsmanPerfHomeAway.png')
    plt.show()
    plt.gcf().clear()
    return  
...
def batsmanRunsFreqPerf(file, name="A Hookshot"):
    ...
    plt.savefig('batsmanRunsFreqPerf.png')
    plt.show()
    plt.gcf().clear()
...
def batsmanRunsRanges(file, name= "A Hookshot") :
    ...
    # Add a title
    atitle= name + '-' + "Runs range  vs Run frequencies"
    plt.title(atitle)
    plt.text(180, 70,'Data source-Courtesy:ESPN Cricinfo',
         horizontalalignment='center',
         verticalalignment='center',
         )
    plt.savefig('batsmanRunsRanges.png')
    plt.show()
    plt.gcf().clear()
    return   
...
def bowlerAvgWktsGround(file, name="A Chinaman"):
    ...
    plt.savefig('bowlerAvgWktsGround.png')
    plt.show()
    plt.gcf().clear()
    return
...
def bowlerAvgWktsOpposition(file, name="A Chinaman"):
    ...
    plt.savefig('bowlerAvgWktsOpposition.png')
    plt.show()
    plt.gcf().clear()
    return
...
def bowlerContributionWonLost(file,name="A Doosra"):
    ...
    plt.savefig('bowlerContributionWonLost.png')
    plt.show()
    plt.gcf().clear()
    return
...
def bowlerCumulativeAvgEconRate(file,name="A Googly"):
    ...
    plt.savefig('bowlerCumulativeAvgEconRate.png')
    plt.show()
    plt.gcf().clear()
    return    
...
def bowlerCumulativeAvgWickets(file,name="A Googly"):
    ...
    plt.savefig('bowlerCumulativeAvgWickets.png')
    plt.show()
    plt.gcf().clear()
    return  
...
def bowlerEconRate(file, name="A Bowler") :
    ...
    plt.savefig('bowlerEconRate.png')
    plt.show()
    plt.gcf().clear()
    return 
...
def bowlerMovingAverage(file,name="A Doosra") :
    ...
    plt.savefig('bowlerMovingAverage.png')
    plt.show()
    plt.gcf().clear()
    return 
...
def bowlerPerfForecast(file, name="A Googly"):
    ...
    plt.title(atitle)
    plt.savefig('bowlerPerfForecast_1.png')
    plt.show()
    
    residuals.plot(kind='kde')
    atitle=name+"-ARIMA plot"
    plt.title(atitle)
    plt.savefig('bowlerPerfForecast_2.png')
    plt.show()
    plt.gcf().clear()
    print(residuals.describe())
...
def bowlerPerfHomeAway(file,name="A Googly") :
    ...
    plt.savefig('bowlerPerfHomeAway.png')
    plt.show()
    plt.gcf().clear()
    return 
...
def bowlerWktsFreqPercent(file, name="A Bowler"):
    ...
    plt.savefig('bowlerWktsFreqPercent.png')
    plt.show()
    plt.gcf().clear()
    return
...
def bowlerWktsRunsPlot(file, name="A Googly"):
    ...
    plt.title(atitle)
    plt.xlabel('Wickets')
    plt.savefig('bowlerWktsRunsPlot.png')
    plt.show()
    plt.gcf().clear()
    return
...
def relativeBatsmanCumulativeAvgRuns(filelist, names):
    ...
    plt.savefig('relativeBatsmanCumulativeAvgRuns.png')
    plt.show()
    plt.gcf().clear()
    return
...
def relativeBatsmanCumulativeStrikeRate (filelist, names):
    ...
    plt.savefig('relativeBatsmanCumulativeStrikeRate.png')
    plt.show()
    plt.gcf().clear()
    return 
...
def relativeBowlerCumulativeAvgEconRate(filelist, names):
    ...
    plt.savefig('relativeBowlerCumulativeAvgEconRate.png')
    plt.show()
    plt.gcf().clear()
    return
...
def relativeBowlerCumulativeAvgWickets(filelist, names):
    ...
    plt.savefig('relativeBowlerCumulativeAvgWickets.png')
    plt.show()
    plt.gcf().clear()
    return
...
def relativeBowlingER(filelist, names):
    ...
    plt.savefig('relativeBowlingER.png')
    plt.show()
    plt.gcf().clear()
    return
...
def batsmanScoringRateODTT(file, name="A Hookshot"):
    ...
    plt.savefig('batsmanScoringRateODTT.png')
    plt.show()
    plt.gcf().clear()
    return
...
def teamWinLossStatusVsOpposition(file,teamName,opposition=["all"],homeOrAway=["all"],matchType="Test",plot=False):
    ...
    if (plot == True):
        ...
        plt.savefig('teamWinLossStatusVsOpposition.png')
        plt.show()
        plt.gcf().clear()
    else:
        # Return dataframe
...
def teamWinLossStatusAtGrounds(file,teamName,opposition=["all"],homeOrAway=["all"],matchType="Test",plot=False):
    ...
    if (plot == True):
        ...
        plt.tight_layout(rect=[0, 0, 1, 0.95])
        plt.savefig('teamWinLossStatusAtGrounds.png')
        plt.show()
        plt.gcf().clear()
    else:
        # Return dataframe
...
def plotTimelineofWinsLosses(file,teamName,opposition=["all"],homeOrAway=["all"],
    ...
    if (matchType == "Test"):
        ...
        plt.suptitle(atitle,fontsize=8)
        plt.title(asub,fontsize=8)
        plt.savefig('plotTimelineofWinsLosses.png')
        plt.show()
        plt.gcf().clear()
